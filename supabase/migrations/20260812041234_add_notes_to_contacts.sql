...
-- Update create_contact to include notes
...
-- Update update_contact to include notes
...
-- Update bulk_upsert_contacts to include notes
...
begin
  ...
  loop
    ...
    v_notes := coalesce(v_value ->> 'notes', '');
